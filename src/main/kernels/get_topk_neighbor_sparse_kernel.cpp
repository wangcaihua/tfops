...
class GetTopKNeighborSparseOp : public AsyncOpKernel {
private:
    int k_;

public:
    explicit GetTopKNeighborSparseOp(OpKernelConstruction *ctx) : AsyncOpKernel(ctx) {
...
REGISTER_KERNEL_BUILDER(
        Name("GetTopKNeighborSparse").Device(DEVICE_CPU), GetTopKNeighborSparseOp);
